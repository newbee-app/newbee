...
export const SearchActions = createActionGroup({
  ...
  events: {
     ...
     */
    Suggest: props<{ query: SuggestDto }>(),
     ...
     */
    'Continue Search Success': props<{ results: QueryResultsDto }>(),
  },
});
