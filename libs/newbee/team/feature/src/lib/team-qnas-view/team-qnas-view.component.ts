...
/**
 * The smart UI for viewing all of the qnas in a team.
 */
@Component({
  selector: 'newbee-team-qnas-view',
  templateUrl: './team-qnas-view.component.html',
})
export class TeamQnasViewComponent implements OnDestroy {
  ...
  constructor(
    ...
    store.dispatch(TeamActions.getQnas());
