...
/**
 * Constant to say that type cannot be an empty string.
 */
export const typeIsNotEmpty = 'Type cannot be an empty string.';
...
/**
 * Constant to say that the value for type must be in SolrOrgEntryEnum.
 */
export const typeIsSolrOrgEntryEnum = `Type can only be one of the following values: ${Object.values(
  SolrOrgEntryEnum,
)}`;

/**
 * Constant to say that the value for type must be in SolrAppEntryEnum.
 */
export const typeIsSolrAppEntryEnum = `Type can only be one of the following values: ${Object.values(
  SolrAppEntryEnum,
)}`;
